...
def create_token_lst(s, str_to_token=tokenization):
    """create token list:
...
def nested_bool_eval(s, custom_tokens=tokenization):
    ...
    """
    return formatted_bool_eval(create_token_lst(s, custom_tokens))